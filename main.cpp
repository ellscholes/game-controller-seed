...
/*PLEASE CHNAGE THESE COLOURS ELL*/
...
SocketAddress lander("192.168.80.1",65200);
SocketAddress dash("192.168.80.1",65250);
...
int main() {
    ...
    while(1) {
        ...
        lcd.locate(0,20);
        lcd.printf("Velocity:%d", velocity);
        red.write(1);
        green.write(1);
        blue.write(1);
        if(isFlying){
        ...
        wait(0.01);/*TODO you may want to change this time
